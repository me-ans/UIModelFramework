...
UIAdaptor::UIAdaptor (UIInstance* instance, const ComponentSpec& spec) :
...
void UIAdaptor::initialiseFromSpec (UIInstance* owner, const ComponentSpec& spec)
{
    // The co-inherited Component must already been constructed!
    Component* comp = getComponent();
    
    jassert (comp != nullptr);
    jassert (getOwner() != nullptr);
